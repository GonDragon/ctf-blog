        ...
        <div className="grid md:grid-cols-2 lg:-mx-24 mt-12">
          {prevPost && (
            <Link href={`/posts/${prevPost.slug}`}>
              <a className="py-8 px-10 text-center md:text-right first:rounded-t-lg md:first:rounded-tr-none md:first:rounded-l-lg last:rounded-r-lg first last:rounded-b-lg backdrop-blur-lg bg-white bg-black bg-opacity-30 bg-opacity-10 hover:bg-opacity-20 hover:bg-opacity-50 transition border border-gray-800 border-white border-opacity-10 border-opacity-10 last:border-t md:border-r-0 md:last:border-r md:last:rounded-r-none flex flex-col">
                <p className="uppercase text-gray-500 mb-4 text-white opacity-60">
                  Previous
                </p>
                <h4 className="text-2xl text-gray-700 mb-6 text-white">
